...
Begin VB.Form FrmWithdrawal 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         TabPicture(3)   =   "FrmWithdrawal.frx":00E6
         Tab(3).ControlEnabled=   0   'False
         Tab(3).Control(0)=   "MSHFlexGrid5"
         Tab(3).ControlCount=   1
         TabCaption(4)   =   "History Detail"
         TabPicture(4)   =   "FrmWithdrawal.frx":0102
         Tab(4).ControlEnabled=   0   'False
         Tab(4).Control(0)=   "Label47"
         Tab(4).Control(1)=   "Label46"
         Tab(4).Control(2)=   "TxtUpdated"
         Tab(4).Control(2).Enabled=   0   'False
         Tab(4).Control(3)=   "TxtCreated"
         ...
         Begin VB.PictureBox Pic_GCTD 
            ...
            Begin VB.ComboBox CmbGCTDClient 
               ...
               EndProperty
               Height          =   360
               ItemData        =   "FrmWithdrawal.frx":011E
               Left            =   5400
               List            =   "FrmWithdrawal.frx":0120
               TabIndex        =   27
               Top             =   1380
               Width           =   4575
            End
            ...
            Begin VB.ComboBox CmbLot 
               ...
               EndProperty
               Height          =   360
               ItemData        =   "FrmWithdrawal.frx":0122
               Left            =   2480
               List            =   "FrmWithdrawal.frx":0124
               Sorted          =   -1  'True
               TabIndex        =   22
               Top             =   540
               Width           =   1230
            ...
            Begin VB.ComboBox CmbStack 
               ...
               EndProperty
               Height          =   360
               ItemData        =   "FrmWithdrawal.frx":0126
               Left            =   1290
               List            =   "FrmWithdrawal.frx":0128
               Sorted          =   -1  'True
               TabIndex        =   21
               Top             =   540
               Width           =   1185
            ...
            Begin VB.ComboBox CmbGodownNo 
               ...
               EndProperty
               Height          =   360
               ItemData        =   "FrmWithdrawal.frx":012A
               Left            =   0
               List            =   "FrmWithdrawal.frx":012C
               Sorted          =   -1  'True
               TabIndex        =   20
               Top             =   540
               Width           =   1290
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin VB.ComboBox CmbExchangeTypeID 
            ...
            EndProperty
            Height          =   360
            ItemData        =   "FrmWithdrawal.frx":012E
            Left            =   1215
            List            =   "FrmWithdrawal.frx":0130
            Sorted          =   -1  'True
            TabIndex        =   1
            Top             =   930
            Width           =   1815
...
Call TableTxn_CxTF_Details("Where TxnType = 'W' " & Wc & " Order By SM_Prefix,CMPID,CxTFNo  ")
...
Dim u As Variant
For u = 2 To MSHFlexGrid5.Rows - 1
    If LCase(MSHFlexGrid5.TextMatrix(u, 1)) = LCase(ISIN_) Then
       If Mod_ = "R" Then
...
tmp = CmbLot.Text
If Check2.Value = 1 Then
   Call TableMst_GSL(" Where  (SpillageFlag = '1' And CMPID = " & mCMPID & " And CommodityID = " & mCommodityID & "  And GodownID = " & mGodownID & " And StackNo = '" & CmbStack.Text & "' And  " & Gen_ExpireGSLFlag & "  )")
ElseIf mExchangeTypeID <> 1 Then
   If Check1.Value = 0 Then
      Call TableMst_GSL(" Where ((ExchangeTypeId = " & mExchangeTypeID & " And CMPID = " & mCMPID & " And CommodityID = " & mCommodityID & " And GodownID = " & mGodownID & " And StackNo = '" & CmbStack.Text & "' And ISINID <> '0' And  " & Gen_ExpireGSLFlag & " )) ")
   ElseIf Check1.Value = 1 Then
      ...
      Else
         ...
         Call TableMst_GSL(" Where ((ExchangeTypeId = " & mExchangeTypeID & " And CMPID = " & mCMPID & " And CommodityID = " & mCommodityID & " And GodownID = " & mGodownID & " And StackNo = '" & CmbStack.Text & "'  And  Flag = 'J')) ")
                  
      End If
   End If
Else
   Call TableMst_GSL(" Where  (ExchangeTypeId = " & mExchangeTypeID & " And CMPID = " & mCMPID & " And CommodityID = " & mCommodityID & "  And GodownID = " & mGodownID & " And StackNo = '" & CmbStack.Text & "' And  " & Gen_ExpireGSLFlag & "  )")
End If
CmbLot.Clear
...
If mExchangeTypeID <> 1 Then
   ...
   Else
      txtmGSLClientIDRow = IIf(IsNull(RsMst_GSL!ClientIDRow), 0, RsMst_GSL!ClientIDRow)
      If mExchangeTypeID = 3 Then
         TxtGSLISINno = IIf(IsNull(RsMst_GSL!ISINID), "", RsMst_GSL!ISINID)
      End If
   End If
...
If mExchangeTypeID = 1 And Check2.Value = 0 Then
...
If mExchangeTypeID = 2 Then 'NCDEX
   If Check1.Value = 0 Then
      If Check2.Value = 0 Then
         If CheckISINinRRNTab() = True Then
            MsgBox "This lot belongs to one ISIN but the selected RRN belongs to a different ISIN!!!"
            CmbLot.SetFocus
            Exit Sub
         End If
     End If
   Else
      If CheckClientinRRNTab() = True And Check2.Value = 0 Then
...
For ir = 2 To MSHFlexGrid2.Rows - 2
    If CmbGCTDClient.Text = MSHFlexGrid2.TextMatrix(ir, 1) & " ~ " & MSHFlexGrid2.TextMatrix(ir, 4) Then
       If mExchangeTypeID <> 2 And Check2.Value = 0 Then ' Check1.Value =1 '30-01-10
       
          If ((Val(MSHFlexGrid2.TextMatrix(ir, 14))) - Val(MSHFlexGrid2.TextMatrix(ir, 15))) < Val(TxtGCTDNoofBags) Then
             MsgBox "Delivered number of bags are more than avalibale number of bags!!!"
             Exit Sub
          End If
       End If
       ...
       If mExchangeTypeID = 2 And Check2.Value = 0 And Check1.Value = 0 Then
       ...
       ElseIf mExchangeTypeID = 1 Then
           tmp = tmp
       ElseIf mExchangeTypeID <> 2 And Check2.Value = 0 Then 'Check1.Value = 0
          If (Round((Val(MSHFlexGrid2.TextMatrix(ir, 8))) - Val(MSHFlexGrid2.TextMatrix(ir, 9)), 3)) < Round(Val(TxtGSLNetWeight), 3) Then
             MsgBox "Delivered Quantity is more than avalibale Quantity!!!"
             Exit Sub
          End If
...
If MSHFlexGrid4.Rows > 3 Then
   For u = 1 To MSHFlexGrid4.Rows - 1
       If MSHFlexGrid4.TextMatrix(u, 1) = CmbGodownNo.Text And _
          ...
          MSHFlexGrid4.TextMatrix(u, 12) = CmbGCTDClient.Text Then
...
MSHFlexGrid1.TextMatrix(0, 11) = "Manual CITF No"
...
If Val(TxtGSLAvailableNofBags) < Val(TxtGCTDNoofBags) Then
   MsgBox "Delivered number of bags must be less than available number of bags!!!"
   TxtGCTDNoofBags.SetFocus
   Exit Sub
End If
Call CalDmatWt
...
If Check1.Value = 0 Then
   ...
   If RsTxn_WHRDetail!PledgeID <> 0 Then
      MsgBox "Warning : This WHR is already pledged!!!"
'      TxtRRNNo.SetFocus
'      Exit Sub
   End If
...
mClientIDRow = RsTxn_CDC_GSLDetail!ClientIDRow
...
For i = 2 To MSHFlexGrid4.Rows - 2
    ...
    If ans(15) < 0 Then
       BalBagNeg = "Y"
    End If
    If MSHFlexGrid4.TextMatrix(1, 12) = "Client Name" And ans(9) <> "" Then
