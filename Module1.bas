...
If Gen_DbPath = "" Then
   ...
   'Gen_DbPath = "Provider=MSOLEDBSQL;Persist Security Info=False;User ID=appuser;pwd=Cy37e$84t#ji6r;Initial Catalog=SM_20251006;Data Source=10.23.12.51,1433"
