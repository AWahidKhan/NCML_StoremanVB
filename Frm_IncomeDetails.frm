...
Begin VB.Form Frm_IncomeDetails 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox CmbSheetName 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "Frm_IncomeDetails.frx":0000
         Left            =   2160
         List            =   "Frm_IncomeDetails.frx":0007
         TabIndex        =   4
         Top             =   360
         Width           =   4020
      End
...
If lblFile.Caption <> "" Then
 ...
 ' Code For Creating List of Sheet in Excel Sheet
   ...
   For I = 1 To oWB.Worksheets.Count
       ...
       Status = 1
       Frame2.Enabled = True
       If LCase(oWS.Name) = "locationwise income" Then 'Or LCase(oWS.Name) = "location s & w" Or LCase(oWS.Name) = "location dp" Then
...
ElseIf LCase(CmbSheetName.Text) = "location dp" Then
   mSheetFlg = "ldp"
ElseIf LCase(CmbSheetName.Text) = "locationwise income" Then
   mSheetFlg = "lwc"
Else
...
For c = 1 To RowCount
    ...
    If mLocationID <> 0 Then
       For j = 1 To MSHFlexGrid1.Cols - 1
           ...
           mEndDate = Null
           If j = 1 Then
              mStartDate = "10/01/2009"
              mEndDate = "10/31/2009"
           ElseIf j = 2 Then
              mStartDate = "11/01/2009"
              mEndDate = "11/30/2009"
           ElseIf j = 3 Then
              mStartDate = "12/01/2009"
              mEndDate = "12/31/2009"
           ElseIf j = 4 Then
              mStartDate = "01/01/2010"
              mEndDate = "01/31/2010"
           ElseIf j = 5 Then
              mStartDate = "02/01/2010"
              mEndDate = "02/28/2010"
           ElseIf j = 6 Then
              mStartDate = "03/01/2010"
              mEndDate = "03/31/2010"
           End If
...
With MSHFlexGrid1
     ...
     .TextMatrix(0, 1) = "Oct 09"
     .TextMatrix(0, 2) = "Nov 09"
     .TextMatrix(0, 3) = "Dec 09"
     .TextMatrix(0, 4) = "Jan 10"
     .TextMatrix(0, 5) = "Feb 10"
     .TextMatrix(0, 6) = "Mar 10"
End With
...
For l = 1 To RowCount
    ...
    If oWS.Cells(mRow, 1) <> "" Then
       MSHFlexGrid1.TextMatrix(l, 0) = Trim(oWS.Cells(l + 1, 1).Value)
       For c = 1 To MSHFlexGrid1.Cols - 1
           MSHFlexGrid1.TextMatrix(l, c) = Val(Format((oWS.Cells(l + 1, c + 1).Value), "########0.00"))
       Next
