   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin VB.ComboBox CmbExchangeTypeID 
            ...
            EndProperty
            Height          =   360
            ItemData        =   "FormWithdrawal.frx":0000
            Left            =   1215
            List            =   "FormWithdrawal.frx":0002
            Sorted          =   -1  'True
            TabIndex        =   121
            Top             =   930
            Width           =   1815
      ...
      Begin TabDlg.SSTab SSTab1 
         ...
         Begin VB.PictureBox Pic_GCTD 
            ...
            Begin VB.ComboBox CmbGodownNo 
               ...
               EndProperty
               Height          =   360
               ItemData        =   "FormWithdrawal.frx":0074
               Left            =   0
               List            =   "FormWithdrawal.frx":0076
               Sorted          =   -1  'True
               TabIndex        =   64
               Top             =   540
               Width           =   1290
            ...
            Begin VB.ComboBox CmbStack 
               ...
               EndProperty
               Height          =   360
               ItemData        =   "FormWithdrawal.frx":0078
               Left            =   1290
               List            =   "FormWithdrawal.frx":007A
               Sorted          =   -1  'True
               TabIndex        =   63
               Top             =   540
               Width           =   1185
            ...
            Begin VB.ComboBox CmbLot 
               ...
               EndProperty
               Height          =   360
               ItemData        =   "FormWithdrawal.frx":007C
               Left            =   2480
               List            =   "FormWithdrawal.frx":007E
               Sorted          =   -1  'True
               TabIndex        =   62
               Top             =   540
               Width           =   1230
            ...
            Begin VB.ComboBox CmbGCTDClient 
               ...
               EndProperty
               Height          =   360
               ItemData        =   "FormWithdrawal.frx":0080
               Left            =   5400
               List            =   "FormWithdrawal.frx":0082
               TabIndex        =   59
               Top             =   1380
               Visible         =   0   'False
               Width           =   4095
...
If RsTxn_CxTF_Details!Flag = "P" Then
   MsgBox "Print out is Generated, You Can't Edit This CITF   !!!! "
   Exit Sub
End If
Dim ans As Variant
...
' This fuction will check for duplicate RRN / WHR No / CDC No added to the grids
...
If MSHFlexGrid1.TextMatrix(I, 0) = "" Then Exit Sub
RsTxn_CxTF_Details.MoveFirst
RsTxn_CxTF_Details.Find "g_uid = '" & MSHFlexGrid1.TextMatrix(I, 12) & "'"
If Not RsTxn_CxTF_Details.EOF Then
   Call Indata
   Frame0.Visible = False
End If
...
If Not RsMst_RRN.EOF Then
   ...
   If Not RsMst_ISIN.EOF Then
      ...
      If mCommodityID_ <> RsMst_ISIN!CommodityID Then
         MsgBox "ISIN commodity and selected Commodity is not matching!!!"
         TxtRRNNo.SetFocus
         Exit Sub
      End If
  End If
...
'      Exit Sub
   ...
   If Not RsTxn_WHRDetail.EOF Then
      If mCMPID_ <> RsTxn_WHRDetail!CMPID Then
         MsgBox "WHR CMP is different from the CMP selected above!!!"
         CmbCMPID.SetFocus
         Exit Sub
      End If
