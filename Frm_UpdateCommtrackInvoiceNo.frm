...
Begin VB.Form Frm_UpdateCommtrackInvoiceNo 
   Caption         =   "Update Commtrack Invoice No"
   ClientHeight    =   3195
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "Frm_UpdateCommtrackInvoiceNo"
...
Call TableTxn_TIDetails '(" Where PIFlag='Commtrack'")
For I = 2 To MSHFlexGrid3.Rows - 1
    ...
    End If
    mInvoice = Replace(MSHFlexGrid3.TextMatrix(I, 18), "Commtrack", "")
    RsTxn_MonthlyCommtrackInvoice.Find "PINo= " & Val(mInvoice) & " " '" & Val(MSHFlexGrid3.TextMatrix(I, 18)) & ""
    If Not RsTxn_MonthlyCommtrackInvoice.EOF Then
       If RsTxn_TIDetails.RecordCount > 0 Then
          RsTxn_TIDetails.MoveFirst
          RsTxn_TIDetails.Find "EntryNo=" & Val(MSHFlexGrid3.TextMatrix(I, 30)) 'RsTxn_TIDetails.Find "PIID=" & RsTxn_ProInvoice!InvoiceNo'RsTxn_TIDetails.Find "EntryNo=" & Val(MSHFlexGrid3.TextMatrix(I, 25)) 'RsTxn_TIDetails.Find "PIID=" & RsTxn_MonthlyCommtrackInvoice!InvoiceID
          If RsTxn_TIDetails.EOF = True Then
             ...
             RsTxn_TIDetails!DepositoryID = RsTxn_MonthlyCommtrackInvoice!CPID 'GetDepositoryIDFromNavCode(RsTxn_MonthlyCommtrackInvoice!CPNAVCode)
...
'             RsTxn_TIDetails!EntryFlag = "System"
             ...
             RsTxn_MonthlyCommtrackInvoice!InvoiceDate = Format(MSHFlexGrid3.TextMatrix(I, 26), Gen_DatFormat)
             RsTxn_MonthlyCommtrackInvoice!InvoiceNo = Trim(MSHFlexGrid3.TextMatrix(I, 25))
             RsTxn_MonthlyCommtrackInvoice!InvSTAmt = Val(MSHFlexGrid3.TextMatrix(I, 27))
             RsTxn_MonthlyCommtrackInvoice!InvoiceAmt = Val(MSHFlexGrid3.TextMatrix(I, 28))
...
Do While Not objTS.AtEndOfStream
    ...
    ps = Split(sFileLine, ",")
    If UBound(ps) <> 30 Then 'If UBound(ps) <> 26 Then    If UBound(ps) <> 25 Then
