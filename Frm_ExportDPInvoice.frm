...
Begin VB.Form Frm_ExportDPInvoice 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox CmbInvoiceType 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "Frm_ExportDPInvoice.frx":0000
         Left            =   6600
         List            =   "Frm_ExportDPInvoice.frx":000A
         Sorted          =   -1  'True
         TabIndex        =   3
         Top             =   240
         Width           =   2055
   ...
   End
End
Attribute VB_Name = "Frm_ExportDPInvoice"
...
If ChkCheckAll.Value = vbChecked Then
   For I = 2 To MSHFlexGrid3.Rows - 1
       ...
       If MSHFlexGrid3.TextMatrix(I, 3) <> "" And MSHFlexGrid3.TextMatrix(I, 6) <> "" And MSHFlexGrid3.TextMatrix(I, 13) <> "" And Val(MSHFlexGrid3.TextMatrix(I, 4)) > 0 Then
          MSHFlexGrid3.row = I
          MSHFlexGrid3.TextMatrix(I, 20) = strChecked
       End If
   Next
Else
   For I = 2 To MSHFlexGrid3.Rows - 1
       MSHFlexGrid3.row = I
       MSHFlexGrid3.TextMatrix(I, 20) = strUnChecked
   Next
End If
End Sub
...
If Option1.Value = True Then
   If CmbInvoiceType.Text = "Non Taxable" Then
      tmp = "Select * From Mst_DPInvoiceUpload Where BatchID is Null  And Flag = 'N' "
   Else
      tmp = "Select * From Mst_DPInvoiceUpload Where BatchID is Null  And Flag = 'T' "
   End If
   Call Tmp1Table
End If
...
'           End If
'       Next
      If .TextMatrix(I, 20) = strChecked Then
...
'          Print #1, tmp
        If Option1.Value = True Then
            If TmpRs1.RecordCount > 0 Then
               TmpRs1.MoveFirst
               TmpRs1.Find "PINo = " & Val(Replace(.TextMatrix(I, 18), "DP", "")) & " "
...
tmp = "select Max(BatchID) from Mst_DPInvoiceUpload"
Call Tmp1Table
If TmpRs1.RecordCount > 0 Then
...
If Option1.Value = True Then
   ...
   End If
   If CmbInvoiceType.Text = "Non Taxable" Then
      wc = " Where  MD.Flag='N' And MD.BatchID is Null"
   ElseIf CmbInvoiceType.Text = "Taxable" Then
      wc = " Where  MD.Flag='T' And MD.BatchID is Null"
   End If
Else
   If CmbBatch.Text = "" Then
      ...
      Exit Sub
   End If
    wc = " Where  MD.BatchID=" & Val(CmbBatch.Text) & ""
'   If CmbInvoiceType.Text = "Non Taxable" Then
...
If TmpRs.RecordCount > 0 Then
   ...
   For I = 1 To TmpRs.RecordCount
       ...
       If CmbInvoiceType.Text = "Non Taxable" Then
          ...
          MSHFlexGrid3.TextMatrix(I + 1, 12) = "Being Storage & Warehouse charges for the DP/NCDEX clients at " & TmpRs!LocationName & " for the month of " & MonthName(Month(TmpRs!MonthYear)) & " " & Year(TmpRs!MonthYear) & " (Without ST) "
       Else
          ...
          MSHFlexGrid3.TextMatrix(I + 1, 12) = "Being Storage & Warehouse charges for the DP/NCDEX clients at " & TmpRs!LocationName & " for the month of " & MonthName(Month(TmpRs!MonthYear)) & " " & Year(TmpRs!MonthYear) & " (With ST) "
