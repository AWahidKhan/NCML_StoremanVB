...
tmp = tmp & " rrn.RRNQty,rrn.DeliveredQty,rrn.OutOfSystemQty,rrn.EntryDate,rrn.Flag,rrn.G_UID "
...
TxtBalanceQty = Format(Val(TxtRRNQty) - (Val(TxtDeliveredQty) + Val(TxtOutOfSystemQty)), "########0.000")
...
If LCase(Gen_UserRole) <> "power" And LCase(Gen_UserRole) = "super admin" Then
...
MSHFlexGrid1.TextMatrix(0, 12) = "Entry Date"
MSHFlexGrid1.TextMatrix(0, 13) = "Flag"
MSHFlexGrid1.TextMatrix(0, 14) = "G-UID"
...
RsMst_RRN.MoveFirst
RsMst_RRN.Find "G_UID = '" & MSHFlexGrid1.TextMatrix(i, 14) & "'"
If Not RsMst_RRN.EOF Then
   Call InData
