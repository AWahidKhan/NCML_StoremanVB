...
Begin VB.Form Frm_UpdateTempInvoiceNo 
   Caption         =   "Update Ad-Hoc Invoice No"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   End
End
Attribute VB_Name = "Frm_UpdateTempInvoiceNo"
...
Call TableTxn_TIDetails '(" Where PIFlag='ADHOC'")
For I = 2 To MSHFlexGrid3.Rows - 1
    ...
    End If
    mInvoice = Replace(MSHFlexGrid3.TextMatrix(I, 18), "AH", "")
    RsTxn_TempInvoice.Find "PINo=" & Val(mInvoice) & "" '" & Val(MSHFlexGrid3.TextMatrix(I, 18)) & ""
    If Not RsTxn_TempInvoice.EOF Then
       If RsTxn_TIDetails.RecordCount > 0 Then RsTxn_TIDetails.MoveFirst
       RsTxn_TIDetails.Find "EntryNo=" & Val(MSHFlexGrid3.TextMatrix(I, 30)) 'RsTxn_TIDetails.Find "PIID=" & RsTxn_TempInvoice!PINo
       If RsTxn_TIDetails.EOF = True Then
          ...
          RsTxn_TIDetails!ClientIDRow = RsTxn_TempInvoice!ClientIDRow
