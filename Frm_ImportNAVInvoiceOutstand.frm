...
Begin VB.Form Frm_ImportNAVInvoiceOutstand 
   Caption         =   "Import NAV outstanding Invoices"
   ClientHeight    =   7335
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   9285
   ...
   End
End
Attribute VB_Name = "Frm_ImportNAVInvoiceOutstand"
...
tmp = "Delete from Txn_NAVInvoiceOutStanding"
Call TmpTable

Call TableTxn_NAVInvoiceOutStanding
...
For I = 1 To RowCount - 2
    ...
    If MSHFlexGrid1.TextMatrix(I, 0) <> "" Then
          RsTxn_NAVInvoiceOutStanding.AddNew
          RsTxn_NAVInvoiceOutStanding!CustomerNo = Trim(MSHFlexGrid1.TextMatrix(I, 0))
          RsTxn_NAVInvoiceOutStanding!CustomerName = Trim(MSHFlexGrid1.TextMatrix(I, 1))
          RsTxn_NAVInvoiceOutStanding!EntryNo = MSHFlexGrid1.TextMatrix(I, 2)
          RsTxn_NAVInvoiceOutStanding!EHOPInvoiceNo = Trim(MSHFlexGrid1.TextMatrix(I, 3))
          RsTxn_NAVInvoiceOutStanding!DocumentType = Trim(MSHFlexGrid1.TextMatrix(I, 4))
          RsTxn_NAVInvoiceOutStanding!DocumentNo = Trim(MSHFlexGrid1.TextMatrix(I, 5))
          RsTxn_NAVInvoiceOutStanding!VoucherNo = Trim(MSHFlexGrid1.TextMatrix(I, 6))
          RsTxn_NAVInvoiceOutStanding!PostingDate = CDate(MSHFlexGrid1.TextMatrix(I, 7))
          
          RsTxn_NAVInvoiceOutStanding!InvoiceAMount = Val(Replace(MSHFlexGrid1.TextMatrix(I, 8), ",", ""))
          RsTxn_NAVInvoiceOutStanding!BaseAmount = Val(Replace(MSHFlexGrid1.TextMatrix(I, 9), ",", ""))
          RsTxn_NAVInvoiceOutStanding!TaxAmount = Val(Replace(MSHFlexGrid1.TextMatrix(I, 10), ",", ""))
          RsTxn_NAVInvoiceOutStanding!RemainingAmount = Val(Replace(MSHFlexGrid1.TextMatrix(I, 11), ",", ""))
                   
          RsTxn_NAVInvoiceOutStanding!Narration = Trim(MSHFlexGrid1.TextMatrix(I, 12))
          RsTxn_NAVInvoiceOutStanding!ActualDatePosted = CDate(MSHFlexGrid1.TextMatrix(I, 13))
          RsTxn_NAVInvoiceOutStanding!ActualTimePosted = MSHFlexGrid1.TextMatrix(I, 14)
          RsTxn_NAVInvoiceOutStanding!RegionCode = Trim(MSHFlexGrid1.TextMatrix(I, 15))
          RsTxn_NAVInvoiceOutStanding!DepartmentCode = Trim(MSHFlexGrid1.TextMatrix(I, 16))
          RsTxn_NAVInvoiceOutStanding!CustomerPostingGroup = Trim(MSHFlexGrid1.TextMatrix(I, 17))
          RsTxn_NAVInvoiceOutStanding!CreatedBy = Gen_UserLoginID
          RsTxn_NAVInvoiceOutStanding!CreatedDate = Now 'Trim(MSHFlexGrid1.TextMatrix(I, 0))
          RsTxn_NAVInvoiceOutStanding!G_UID = GetGUID
          RsTxn_NAVInvoiceOutStanding.Update
    Else
...
Call Gen_Create_Xls(Gen_mTimeStamp & Gen_UserName & "NAVInvoiceOuststanding.xls")
Call Xls_Detail_Rpt
CmdExcel.Enabled = False
End Sub
...
Dim Pat As String
Pat = App.Path
Set oWB = oXL.Workbooks.Open(Pat & "\Excel\" & Gen_mTimeStamp & Gen_UserName & "NAVInvoiceOuststanding.xls")
